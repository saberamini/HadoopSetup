...
Working with Hadoop (new Repository)
...
You can now check the health of your HDFS on your broswer.  Open up firefox in your virtual machine (not your native operating system)
In the browser type:

> http://localhost:50070

You should see a website with details about your DFS.  Look around and familiarize yourself with the website.  Look at Utilities - Logs, and take a look at the logs.  As an administrator, you will be looking at these log files and trying to find any ERRORS.  Usually the errors that happen are due to user permission issues.


Startup YARN on NameNode.  REmember YARN stood for "Yet Another Resource Locator" And if you remember from lectures it was the second version of MapReduce.  Some still call this MapReduce 2.0.  Also recall that MapReduce was a software package that allowed us to work with HDFS.

> $HADOOP_HOME/sbin/start-yarn.sh

> $HADOOP_HOME/sbin/mr-jobhistory-daemon.sh start historyserver

Finally check whether you Java process are running:

> jps

You should see about 5 different java processes running
...
List the files that are in your DFS

> hdfs dfs -ls /

There should be nothing there because we just formatted our file system.  

Now make a folder called user.

> hdfs dfs -mkdir /user

Click the <i>Utilities</i> tab of the browser and then click "Browse file system"
